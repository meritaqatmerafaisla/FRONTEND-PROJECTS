...
import img1 from '../assets/Images/denim.webp';
import img2 from '../assets/Images/cool.jpeg';
import img3 from '../assets/Images/Coat Crouching.webp';
import img4 from '../assets/Images/shirt-girls.jpeg';
  ...
  return (
    <Section  ref={ref} id="fixed-target" className="new-arrival">
      ...
      <Container ref={ScrollingRef}>
        <Photos img={img1} name="Jacket" />
        <Photos img={img2} name="Cool Dresses" />
        <Photos img={img3} name="Coat Crouching" />
        <Photos img={img4} name="Shirt" />
      </Container>
