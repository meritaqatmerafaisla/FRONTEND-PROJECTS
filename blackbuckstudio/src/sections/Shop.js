  ...
  return (
    <Section ref={ref} id="shop">
      ...
      <Right data-scroll ref={Horizontalref}>
        <Product img={img3} title="Blazers" />
        <Product img={img4} title="T-shirt" />
        <Product img={img1} title="Man Basics" />
        <Product img={img2} title="Tops" />
        <Product img={img5} title="Jewellery" />
        <Product img={img6} title="Cool jacket" />
        <Product img={img7} title="Antiques" />
        <Product img={img8} title="Makeup" />
        <Product img={img9} title="perfume" />
        <Product img={img10} title="Pink Overcoat " />
      </Right>
    </Section>
  );
};
